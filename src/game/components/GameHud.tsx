      ...
      <View style={styles.topRow}>
        ...
        <View style={styles.topTools}>
          <Pressable
            ...
            onPress={() =>
              showGameDialog(
                `Серия входов: ${streak} дн. Заходи каждый день, чтобы сохранить огонёк.`,
                { title: "Серия входов" },
              )
            }
          >
